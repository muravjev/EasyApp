    ...
    public sealed class ParseOptionTests
    {
        ...
        public void BoolParsed(string arg, bool value)
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(result.Options.Option, Is.EqualTo(value));
            });
        }
        ...
        public void CharParsed(string arg, string value)
        {
            ...
            {
                Assert.That(result.IsParsed, Is.EqualTo(true));
                Assert.That(result.Options.Option, Is.EqualTo(DateTime.Parse(value)));
            });
        }
        ...
        public void GuidParsed(string arg, string value)
        {
            ...
            {
                Assert.That(result.IsParsed, Is.EqualTo(true));
                Assert.That(result.Options.Option, Is.EqualTo(Guid.Parse(value)));
            });
        }

        [Test]
        [TestCase("1.2", 1.2)]
        [TestCase("-1.063E-02", -1.063E-02)]
        [TestCase("-4320.64", -4320.64)]
